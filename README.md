...
<p align="center">
  I build modern web applications from front to back — crafting responsive UIs with
  <strong>Vue / React</strong>, powering APIs with <strong>Node.js / Laravel</strong>,
  and deploying on <strong>DigitalOcean / Firebase / Supabase</strong>.
</p>
...
| --- | --- | --- |
| [**IBIBES Frontend**](https://github.com/YhaZt/ibibes_frontend) | Modern Vue.js app with Quasar for the IBIBES platform | Vue · Quasar · Supabase |
| [**Document Tracker**](https://github.com/YhaZt/ibibes-document-tracker) | Document tracking system for streamlined workflows | Vue · TypeScript · Node.js |
| [**RITE**](https://github.com/YhaZt/RITE) | Full-stack web app for the VPRITE organization | JavaScript · Node.js · Express |
| [**LMS**](https://github.com/YhaZt/lms) | Learning Management System for educational content | Vue · Firebase · Quasar |
| [**Medicine Scheduler**](https://github.com/YhaZt/MedicineScheduler) | VPS-deployed app for medicine schedules & reminders | Vue · DigitalOcean · Node.js |
| [**Expenses App**](https://github.com/YhaZt/ExpensesApp) | Personal finance expense tracker | TypeScript · React · Firebase |
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=YhaZt&color=38bdf8&style=flat-square" alt="Profile views" />
</p>
